...
const App = () => {
  ...
  const updateStake = (newStake) => {
    ...
    setStake(stake + newStake); // Update the state variable with the new amount
  };
  const resetStake = () => {
...
const playerLose = () => {
  ...
  return ( //Image background may need to replace styles.container line
    <ImageBackground source={require('./assets/diceboard.png')} style={styles.container}>
...
const styles = StyleSheet.create({
  ...
  textInput: {
    ...
    fontWeight: 'bold',
    color: 'black',
    fontSize: 25, // Decreased font size to fit more buttons horizontally
    padding: 10,
    width: 170,
  },
  horizontalButtons: {
